...
with st.sidebar:
    ...
    box_cost = st.number_input("How much does it cost: ", value=None, placeholder="Type a number...")
    box_product = st.text_input("What did you spend on: ")

    st.button("Another Spending day 🥲", on_click= take_value, args=(box_date,box_payment,box_cost,box_product))
